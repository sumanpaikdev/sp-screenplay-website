...
const PictureCard = ({ picture }) => (
  ...
  <div className=" w-[270px] h-[440px] sm:w-[310px] sm:h-[480px] shadow-md bg-white relative ml-3 sm:ml-4 sm:hover:-translate-y-6 duration-300 flex-none snap-center rounded-md overflow-hidden">
    <div className="">
      <img
        src={picture.url}
        alt="all need one"
    ...
    <div className="px-6 sm:py-4 py-2 flex flex-col justify-center items-center">
      <p className="mt-8 text-sm sm:text-md text-center font-semibold text-gray-700 uppercase"><span className="text-[#603601]">{picture.type} |</span> {picture.title}</p>
      <p className="text-center text-gray-700 text-sm">
        {picture.description}
      </p>
      <p className="text-center font-bold bg-gradient-to-r from-black via-rose-600 to-rose-600 text-transparent bg-clip-text uppercase text-sm mt-3 animate-pulse">
        {picture.status}
      </p>
    </div>
  </div>
